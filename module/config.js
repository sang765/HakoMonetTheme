(function() {
    ...
    const COLORIS_CSS_URL = IS_LOCAL ? `${window.HMTBaseUrl}/lib/coloris.min.css` : 'https://sang765.github.io/HakoMonetTheme/lib/coloris.min.css';
    const COLORIS_JS_URL = IS_LOCAL ? `${window.HMTBaseUrl}/lib/coloris.min.js` : 'https://sang765.github.io/HakoMonetTheme/lib/coloris.min.js';
    const COLORIS_COLORS_URL = IS_LOCAL ? `${window.HMTBaseUrl}/lib/coloris-colors.json` : 'https://sang765.github.io/HakoMonetTheme/lib/coloris-colors.json';
