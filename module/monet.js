(function() {
    ...
    function initMonet() {
        ...
        analyzeImageColorWithHairFocus(coverUrl)
            .then(dominantColor => {
                ...
                // Tạo Monet color palette từ màu chủ đạo
                const monetPalette = generateMonetPalette(dominantColor);
                debugLog('Monet Palette:', monetPalette);
                
                const isLightColor = isColorLight(dominantColor);
    ...
    function isColorLight(color) {
        ...
        debugLog('Độ sáng màu', color, ':', brightness);
    ...
    function applyDefaultColorScheme() {
        ...
        const defaultPalette = generateMonetPalette(defaultColor);
    ...
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initMonet);
    } else {
        initMonet();
    }
})();
