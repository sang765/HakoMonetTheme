(function() {
    ...
    function enhanceSeriesPage() {
        ...
        GM_addStyle(`@import url('https://sang765.github.io/HakoMonetTheme/styles/series-enhancement.css');`);
    ...
    function generateDeviceSpecificCSS(device) {
        ...
        let css = `@import url('https://sang765.github.io/HakoMonetTheme/styles/device-base.css');`;

        if (isMobile) {
            css += `@import url('https://sang765.github.io/HakoMonetTheme/styles/device-mobile.css');`;
        } else if (isTablet) {
            css += `@import url('https://sang765.github.io/HakoMonetTheme/styles/device-tablet.css');`;
        } else if (isDesktop) {
            css += `@import url('https://sang765.github.io/HakoMonetTheme/styles/device-desktop.css');`;
        }
    ...
    function setupPortraitCSSRedesign() {
        ...
        function applyPortraitCSS() {
            ...
            GM_addStyle(`@import url('https://sang765.github.io/HakoMonetTheme/styles/portrait.css');`);
    ...
    function addThumbnailFadeEffect(coverUrl) {
        ...
        // Thêm styles
        GM_addStyle(`
            @import url('https://sang765.github.io/HakoMonetTheme/styles/thumbnail-overlay.css');
    ...
    function addTransparentTopCSS() {
        GM_addStyle(`@import url('https://sang765.github.io/HakoMonetTheme/styles/transparent-top.css');`);
