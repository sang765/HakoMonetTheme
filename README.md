...
Branch này được tạo để phát triển và kiểm tra tính năng mới trước khi hợp nhất vào nhánh chính (main branch).  
Vui lòng không sử dụng nhánh này cho mục đích sử dụng hàng ngày.
